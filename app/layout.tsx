...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Prabodha J",
    "prabodhaj.com",
    "Prabodha Jayawardena Portfolio",
    "Prabodha Jayawardena Projects",
    "Prabodha Jayawardena Skills",
    "Prabodha Jayawardena Experience",
    "Prabodha Jayawardena Education",
    "Prabodha Jayawardena Contact",
    "Prabodha Jayawardena",
    "Prabodha Jayawardena Resume",
  ],
  authors: [
    {
      name: "Prabodha Jayawardena",
      url: "https://prabodhaj.com",
    },
  ],
  creator: "Prabodha Jayawardena",
  openGraph: {
    type: "website",
    locale: "en_US",
    url: siteConfig.url,
